  ...
  return (
    <section className="bg-ct-background">
      ...
      <div className="mx-auto max-w-4xl px-6 pb-16 pt-8 text-center">
        ...
        <p className="mx-auto mt-5 max-w-2xl text-lg leading-relaxed text-ct-muted-foreground">
          {ACME.hero.subtitle}
        </p>
        ...
        <p className="mt-6 text-sm text-ct-muted-foreground">
          {ACME.hero.socialProof}
        </p>
      </div>
    ...
    <section className="bg-ct-muted">
      ...
      <div className="mx-auto grid max-w-6xl grid-cols-1 items-center gap-12 px-6 py-16 lg:grid-cols-2 lg:py-20">
        <div className="min-w-0">
          ...
          <p className="mt-4 text-sm text-ct-muted-foreground">
            {ACME.hero.socialProof}
          </p>
        </div>
        <div className="grid grid-cols-2 gap-3">
          {ACME.stats.map((stat) => (
            ...
            >
              <p className="font-ct-heading text-2xl font-bold text-ct-primary">
                {stat.value}
              </p>
  ...
  return (
    <section className="relative overflow-hidden bg-ct-primary text-ct-primary-foreground">
      ...
      <div className="relative mx-auto max-w-3xl px-6 py-20 text-center">
        <h1 className="font-ct-heading text-4xl font-bold leading-tight sm:text-5xl">
          {ACME.hero.title}
        </h1>
        <p className="mx-auto mt-5 max-w-xl text-ct-primary-foreground/85">
          {ACME.hero.subtitle}
        </p>
        <Button size="lg" variant="inverted" className="mt-8">
          Start free trial
        </Button>
        <p className="mt-4 text-sm text-ct-primary-foreground/70">
          {ACME.hero.socialProof}
        </p>
      </div>
    </section>
