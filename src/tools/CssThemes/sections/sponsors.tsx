  ...
  return (
    <section className="bg-ct-background px-6 py-12">
      <div className="mx-auto max-w-6xl">
        <p className="text-center text-sm text-ct-muted-foreground">
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-x-12 gap-y-6">
          {ACME.sponsors.map((sponsor) => (
            <span
              key={sponsor.name}
              className="font-ct-heading text-lg font-semibold text-ct-muted-foreground/60"
            >
              {sponsor.name}
            </span>
          ))}
          <span className="font-ct-heading text-lg font-semibold text-ct-muted-foreground/40">
            CloudBase
          </span>
          <span className="font-ct-heading text-lg font-semibold text-ct-muted-foreground/40">
            DataFlow
