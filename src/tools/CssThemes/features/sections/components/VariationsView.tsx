...
export function VariationsView({ category, selectedVariationId, onSelectVariation }: VariationsViewProps) {
	...
	return (
		<div className="flex flex-col gap-6">
			...
			{selectedVariation && <DetailView key={selectedVariation.id} variation={selectedVariation} />}
		</div>
	);
}
