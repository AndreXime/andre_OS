...
const variants = {
  ...
  secondary:
    "bg-ct-secondary text-ct-secondary-foreground ring-1 ring-inset ring-ct-border",
  destructive:
    "bg-ct-destructive/15 text-ct-destructive ring-1 ring-inset ring-ct-destructive/25",
